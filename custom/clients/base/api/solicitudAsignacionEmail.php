...
class SolicitudAsignacionEmail extends SugarApi
{
    ...
    public function buildBodyNotificaAutorizacionDiferenteRegion($nombre_asesor_solicita, $nombre_cuenta)
    {
        $mailHTML = '<head>
            <title></title>
            <meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
    ...
    public function buildBodyNotificaRechazoDiferenteRegion($nombre_asesor_solicita, $nombre_cuenta)
    {
        $mailHTML = '<head>
            <title></title>
            <meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>
