...
class ObtenerRelacionesAltaPO extends SugarApi
{
    ...
    public function generaRegistroPO($api, $args){
        ...
        try{
            ...
            $detalleOrigen = ($beanCuenta->detalle_origen_c == '114' || $beanCuenta->detalle_origen_c == '115' || $beanCuenta->detalle_origen_c == '116' || $beanCuenta->detalle_origen_c == '117')? $beanCuenta->detalle_origen_c: ''; //DETALLE ORIGEN UTILITY TRAILERS/KONNECT/VENDORS/REDITUS
